                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          CokiSwimmingPw5bv6hywjzbgs8tmu(
                            ck70e9ow9s3zxkp3bgi69id: 'Trending',
                            u6gl4aaf9lrrbm: _yspa4sm9tc3ci == 0,
                            wi67icsbrjkrud3tjog1r0nv: () =>
                                setState(() => _yspa4sm9tc3ci = 0),
                          ),
                          const SizedBox(width: 8),
                          CokiSwimmingPw5bv6hywjzbgs8tmu(
                            ck70e9ow9s3zxkp3bgi69id: 'For you',
                            u6gl4aaf9lrrbm: _yspa4sm9tc3ci == 1,
                            wi67icsbrjkrud3tjog1r0nv: () =>
                                setState(() => _yspa4sm9tc3ci = 1),
                          ),
                          const SizedBox(width: 8),
                          CokiSwimmingPw5bv6hywjzbgs8tmu(
                            ck70e9ow9s3zxkp3bgi69id: 'Movie',
                            u6gl4aaf9lrrbm: _yspa4sm9tc3ci == 2,
                            wi67icsbrjkrud3tjog1r0nv: () =>
                                setState(() => _yspa4sm9tc3ci = 2),
                          ),
                          const SizedBox(width: 8),
                          CokiSwimmingPw5bv6hywjzbgs8tmu(
                            ck70e9ow9s3zxkp3bgi69id: 'Visual Arts',
                            u6gl4aaf9lrrbm: _yspa4sm9tc3ci == 3,
                            wi67icsbrjkrud3tjog1r0nv: () =>
                                setState(() => _yspa4sm9tc3ci = 3),
                          ),
                        ],
                      ),
                    ),
